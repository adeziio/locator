...
import { MenuOutlined, NearMe, Help } from '@mui/icons-material';
...
export default class Header extends Component {
    ...
    render() {
        ...
        const leftOption = ['Search', 'Direction'];
        const rightOption = ['Help'];

        return (
            <>
                <AppBar position="fixed" sx={{ backgroundColor: "#00b5ad" }}>
                            ...
                            <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                                {leftOption.map((option, index) => (
                                    <Button
                                        ...
                                        sx={{ my: 2, backgroundColor: page === option ? "rgba(1,1,1,0.5)" : "#00b5ad", display: 'block', color: "white" }}
                                    >
                                        {option}
                                    </Button>
                                ))}
